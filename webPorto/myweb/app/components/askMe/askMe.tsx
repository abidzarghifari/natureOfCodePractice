	...
	return (
		<>
			<div className={`fixed top-0 left-0 w-full md:max-w-sm md:top-5 md:left-auto md:right-5 transition-all duration-500 ease-in-out 
				...
				{/**head*/}
				<div className="flex justify-between p-3 bg-foreground text-background md:rounded-t-md">
				...
				{/**content */}
				<div className="h-screen md:h-[60dvh] lg:h-[80dvh] bg-muted p-2 text-foreground md:rounded-b-md">
					<p>coba</p>
				</div>
			</div>
		</>	
